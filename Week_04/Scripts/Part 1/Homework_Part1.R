...
# cvmd@hawaii.edu
# 09/22/2026 
# This script can calculate the mean and variance of body mass by species, island, and sex without any NAs. It also filters out (i.e. excludes) male penguins, then calculates the log body mass, 
